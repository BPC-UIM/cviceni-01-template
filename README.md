...
3. **Detekuje chybějící hodnoty** (NaN) a odlehlé hodnoty pomocí metod Z-skóre a IQR.
...
### 4. Metriky vzdálenosti a axiomy metriky
...
- Funkce vrací dvojici `(np.ndarray, list[str])` – datovou matici a seznam názvů sloupců.
